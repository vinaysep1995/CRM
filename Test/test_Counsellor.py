...
class TestOne(BaseClass):
    ...
    def test_LeadAddition(self,getData):
        ...
        log.info("Consellor login successfully")
        ...
        counsellor = Select(self.driver.find_element_by_id("counsellor")).select_by_value('34')
    ...
    @pytest.fixture(params=TestData.test_Counsellor_LeadAddition)
