...
class TestOne(BaseClass):
    ...
    def test_LeadAddition(self,getData):
        ...
        log.info("Manager login successfully")
        ...
        counsellor = Select(self.driver.find_element_by_id("counsellor")).select_by_value('36')
    ...
    @pytest.fixture(params=TestData.test_Manager_LeadAddition)
