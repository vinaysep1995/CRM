...
#py.test --html=reports.html////generate html reports
...
class TestOne(BaseClass):
    ...
    def test_LeadAddition(self,getData):
        ...
        counsellor = Select(self.driver.find_element_by_id("counsellor")).select_by_value('33')
    ...
    @pytest.fixture(params=TestData.test_Admin_LeadAddition)
    def getData(self, request):
        return request.param

    # def test_Leadstaging(self):
    #     pass
#//main /div[2]/div[3]/div/div[2]/div[1]
#//div[@class='flex flex-col']/div[1]/div[1]
